...
function initializeStore() {
    store[0] = { order_type: 'buy', no_shares: 100, price: 102.5, id: 253 };
    store[1] = { order_type: 'sell', no_shares: 200, price: 101.75, id: 254 };
    store[2] = { order_type: 'buy', no_shares: 150, price: 101.2, id: 255 };
    store[3] = { order_type: 'sell', no_shares: 300, price: 102.0, id: 256 };
    store[4] = { order_type: 'buy', no_shares: 50, price: 100.5, id: 257 };
}
